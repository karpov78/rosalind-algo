...
PAM250 = parseIntMatrix(
    ...
    '-2 -4 -4 -5 4 -5 -5 -3 -3 -2 -6 -5 -5 -4 -3 0 -2 -8 0 -2',
    ...
    '-4 -4 -4 -6 -4 -5 -5 -5 -2 1 2 -5 0 9 -5 -3 -2 0 7 -1',
    '1 0 -1 -1 -3 0 -1 -1 0 -2 -3 -1 -2 -5 6 1 0 -6 -5 -1',
    '1 0 1 0 0 -1 0 1 -1 -1 -3 0 -2 -3 1 3 1 -2 -3 -1',
    '1 -1 0 0 -2 -1 0 0 -1 0 -2 0 -1 -2 0 1 3 -5 -3 0',
...
class LevMatrixCell:
    ...
    def __str__(self):
        return "%3d (%d, %d)" % (self.weight, self.x, self.y)
...
class LevMatrix:
    ...
    def _calculateMatrix(self):
        ...
        for i in range(-1, len_s):
            sys.stdout.write("\r%3d%%" % (i * 100 / len_s))
            sys.stdout.flush()
